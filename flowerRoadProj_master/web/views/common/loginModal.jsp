...
<meta name="google-signin-client_id"
	content="477566022295-va6h7acae97e1sfavcdnbrfcii3g7r8s.apps.googleusercontent.com">
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				...
				<h4 class="modal-title" id="myModalLabel">로그인이 필요합니다.</h4>
				</div>
				<div class="modal-body">
					<form id="loginForm" class="form-horizontal" action="<%=request.getContextPath()%>/login.me" method="post">
						
						<div class="form-group">
						
						<label for="userId" class="col-xs-4 control-label">아이디</label>
							<div class="col-xs-8">
								<input type="text" class="form-control" name="userId" id="userId"placeholder="아이디">
							</div>
						</div>
							<div class="form-group">
								<label for="userPwd" class="col-xs-4 control-label">비밀번호</label>
								<div class="col-xs-8">
						...
						<div class="SNSbtn">
							...
							<div class="form-group ">
								<div
									class="g-signin2 "
									onclick="GoogleLogin()" data-onsuccess="onSignIn"
									data-theme="dark"></div>
							</div>
						</div>
