...
public class AdminDeliveryCompleteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 배송 완료 주문 리스트
		ArrayList<AdminOrder> admin_deliverycompleteList = aos.admin_deliverycompleteList();
		...
		request.setAttribute("admin_orderList", admin_deliverycompleteList);
