...
@WebServlet("/payComplete.admin")
public class AdminPayCompleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public AdminPayCompleteServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 결제 완료 주문 리스트
		ArrayList<AdminOrder> admin_paycompleteList = aos.admin_paycompleteList();
		...
		request.setAttribute("admin_orderList", admin_paycompleteList);
