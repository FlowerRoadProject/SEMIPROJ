...
@WebServlet("/regiProduct.admin")
public class AdminProductRegiServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public AdminProductRegiServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/admin_views/admin_ProductRegi.jsp").forward(request, response);
	}
